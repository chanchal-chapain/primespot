...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Primespot Store!</h1>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/redmi_9prime.jpeg" alt="redmi 9">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Redmi 9 Prime</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/samsunggalaxy_a21s.jpg" alt="samsung galaxy a21s">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/xiaomi_m10.jpg" alt="xiaomi m10">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Xiaomi M10</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/apple_12_mini.png" alt="apple 12 mini">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Apple 12 Mini</h3>
                                    <p>Price: Rs. 126000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/hp_laptop.png" alt="HP i5 Laptop">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>HP i5 Laptop</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Dell_laptop.jpg" alt="Dell i5 Laptop">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Dell i5 Laptop</h3>
                                    <p>Price: Rs. 68500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/acer_laptop.jpg" alt="Acer i5">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Acer i5 gaming</h3>
                                    <p>Price: Rs. 106000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/mac_laptop.jpg" alt="mac laptop">
                            </a>
                            <center>
                                <div class="caption">
